...
public class MainActivity extends AppCompatActivity {
    ...
    private CommonAdapter<BeanInformation> commonAdapter;
    private List<BeanInformation> beanInformationList;
    ...
    protected void initData() {
        ...
        addData(mPos);
        commonAdapter = new CommonAdapter<BeanInformation>(this, R.layout.item_view, beanInformationList) {
            @Override
            protected void convert(ViewHolder viewHolder, final BeanInformation item, int position) {

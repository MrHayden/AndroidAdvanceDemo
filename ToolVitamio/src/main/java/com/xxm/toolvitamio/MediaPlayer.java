...
import com.xxm.toolvitamio.utils.ContextUtils;
import com.xxm.toolvitamio.utils.FileUtils;
 ...
 * {@link com.xxm.toolvitamio.widget.VideoView}. This class will function the same as
...
public class MediaPlayer {
   ...
   *
   * @see com.xxm.toolvitamio.MediaPlayer.OnInfoListener
   */
   ...
   * @see com.xxm.toolvitamio.MediaPlayer#getTrackInfo
   */
   ...
   *         width and height is not available.
	 *         @see com.xxm.toolvitamio.widget.VideoView#setVideoLayout(int, float)
   */
  ...
  /**
   * @return the percent
   * @see com.xxm.toolvitamio.MediaPlayer.OnBufferingUpdateListener
   */
